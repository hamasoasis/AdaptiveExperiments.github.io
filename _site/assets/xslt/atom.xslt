  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/about/">About</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/overview/">Project Overview</a></li>
                      ...
                      <li><a  href="http://localhost:4000/adaptive/">Adaptive Experiment</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/">Conferences &amp; Events</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/workshops/">SIPS Workshop</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/">Documentation</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/mooclet/">MOOClet</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/upgrade/">UpGrade</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/oli/">OLI</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/overview/">Experiment</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/mooclet/">A/B Testing</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/mooclet/">Contextual Exp</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/mooclet/">Non-Contextual</a></li>
	...
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="EASI – Experiments-As-A-Service-Infrastructure">
				<img src="http://localhost:4000/assets/img/easi_logo.png" alt="EASI – Experiments-As-A-Service-Infrastructure">
			</a>
